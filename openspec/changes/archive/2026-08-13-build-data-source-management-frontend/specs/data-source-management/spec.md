...
- **THEN** name SHALL be 1–100 characters, host SHALL contain no protocol, port SHALL be 1–65535, username SHALL be 1–128 characters, timeout SHALL be 1–30 seconds, and description SHALL be at most 500 characters
...
- **THEN** engine SHALL remain fixed to MYSQL, default database SHALL be manual text in phase one, SSL SHALL be one of DISABLED/PREFERRED/REQUIRED, and only documented JDBC property keys/values SHALL be selectable
