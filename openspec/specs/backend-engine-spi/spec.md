...
- **WHEN** a visible data source with `engine=POSTGRESQL` is tested, browsed for schema or relationships, executed against, or used for export
- **THEN** the service SHALL use the POSTGRESQL engine implementation with schemas as NAMESPACE
