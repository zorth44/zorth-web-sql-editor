...
public class SqlEditorMetrics {
    ...
    private String safe(String value){if(value==null)return "unknown";switch(value){case"success":case"invalid":case"unavailable":case"list":case"detail":case"create":case"update":case"delete":case"failed":return value;default:return"other";}}
